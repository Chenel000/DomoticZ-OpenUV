...
return {
	...
	execute = function(dz, item)
	    ...
	    local uvIndex    = 287 -- idx of UV index device. Type UV
	    local uvIndexMax = 288 -- idx of UV index max device. Type UV
	    local ozoneLevel = 289 -- idx of Ozone device. Type Custom, units du
      local safeTimeS1 = 290 -- idx of Safe Time Skin Type1 device. Units Minutes
      local safeTimeS2 = 291 -- idx of Safe Time Skin Type2 device. Units Minutes
      local safeTimeS3 = 292 -- idx of Safe Time Skin Type3 device. Units Minutes
      local safeTimeS4 = 293 -- idx of Safe Time Skin Type4 device. Units Minutes
      local safeTimeS5 = 294 -- idx of Safe Time Skin Type5 device. Units Minutes
      local safeTimeS6 = 295 -- idx of Safe Time Skin Type6 device. Units Minutes
      local uvIMaxTime = 296 -- idx of UV Max Index Time. Units hh.mm
      local latitude   = '20.34' -- Update with your latitude
      local longitude  = '-1.53' -- Update with your longitude
